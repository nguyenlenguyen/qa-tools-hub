...
const JsonFormatter = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col min-h-[600px] xl:h-[calc(100vh-12rem)]">
...
const Base64Converter = () => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col min-h-[600px] xl:h-[calc(100vh-12rem)] max-w-6xl">
      <div className="bg-gray-50 border-b border-gray-200 px-4 py-3 flex flex-wrap gap-4 items-center justify-between">
        <div className="flex items-center gap-2">
          <button onClick={clearInput} className="flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-red-600 hover:bg-red-50 rounded-lg transition-colors">
            <Trash2 size={16} /> <span className="hidden sm:inline">Clear</span>
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex font-sans text-gray-800">
      ...
      <main className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden">
        ...
        {/* Top Header */}
        <header className="h-16 bg-white border-b border-gray-200 flex items-center px-4 shrink-0 lg:px-8 justify-between lg:justify-end">
          <button
          ...
          <div className="flex items-center gap-3 text-sm font-medium text-gray-600 bg-gray-50 px-3 py-1.5 rounded-full border border-gray-200">
